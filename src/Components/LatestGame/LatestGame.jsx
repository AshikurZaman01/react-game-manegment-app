...
const LatestGame = () => {
    ...
    return (
        <div>
            <div  data-aos="fade-up" data-aos-duration="3000" className=' bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 opacity-70 h-screen flex flex-col justify-center items-center my-[100px]'>
                <div className=' my-10 mx-auto flex sm:flex-col md:flex-row justify-between items-center text-center gap-6'>
